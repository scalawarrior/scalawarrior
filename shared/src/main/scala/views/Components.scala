...
object Components {
  ...
  def gameover(level: Int) = {
    div(`class`:="modal", id:="gameOverModal", tabindex:="-1", role:="dialog", attr("aria-labelledby"):="staticModalLabel", attr("aria-hidden"):="true", attr("data-show"):="true", attr("data-keyboard"):="false", attr("data-backdrop"):="static")(
  ...
  def clear(level: Int) = {
    div(`class`:="modal", id:="clearModal", tabindex:="-1", role:="dialog", attr("aria-labelledby"):="staticModalLabel", attr("aria-hidden"):="true", attr("data-show"):="true", attr("data-keyboard"):="false", attr("data-backdrop"):="static")(
      div(`class`:="modal-dialog")(
        div(`class`:="modal-content")(
